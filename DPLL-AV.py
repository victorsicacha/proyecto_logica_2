...
#dpll recive conjuntos de literales sin dobles negaciones y retorna la primera y solo una implementacion del valor de verdad de cada literalen un diccionario
